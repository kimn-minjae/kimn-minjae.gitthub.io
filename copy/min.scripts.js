...
!function(t, e) {
    ...
    s.m = i = [function(t, e, i) {
        ...
        var f, p, m, d = new s, g = !0, v = !1, y = [], b = function() {
            function i(t, e) {
                !function(t, e) {
                    if (!(t instanceof e))
                        throw new TypeError("Cannot call a class as a function")
                ...
                this.settings.breakpoint && document.documentElement.clientWidth <= this.settings.breakpoint || ("IntersectionObserver"in window || (g = !1),
                this.lastPosition = -1,
            ...
            return function(t, e, i) {
                ...
                value: function() {
                    clearTimeout(m),
                    m = setTimeout(this.handleResize, 500)
                }
            }, {
                key: "handleResize",
                value: function() {
                ...
                value: function() {
                    ...
                    y = y.filter(function(t) {
                        if (!e.elements.includes(t.element))
                            return t;
                        i.push(t)
                    });
                    ...
                    (f = y.length) || (window.cancelAnimationFrame(p),
...
, function(module, exports, __webpack_require__) {
    ...
    (0,
    _jarallaxVideo2["default"])();
    (0,
    _liteReady2["default"])(function() {
        ...
        ["initImg", "canInitParallax", "init", "destroy", "clipContainer", "coverImage", "isVisible", "onScroll", "onResize"].forEach(function(key) {
            ...
            Jarallax.prototype[key] = function() {
                ...
                case "onScroll":
                    ...
                    var my = moveY;
                    var mx = moveX;
                    if (self.options.thresholdY !== null && moveY > self.options.thresholdY)
                        my = 0;
                    if (self.options.thresholdX !== null && moveX > self.options.thresholdX)
                        mx = 0;
                    self.css(self.$item, {
...
!function(n) {
    ...
    n(window).on("load", function() {
        ...
        n(".typed-subtitle").length && 1 < n(".h-subtitle p").length && n(".typed-subtitle").each(function() {
            n(this).typed({
        ...
        setTimeout(function() {
            ...
            n(".typed-bread").length && n(".typed-bread").typed({
    ...
    n("header .top-menu, .typed-bread, .popup-box .bts, .animate-to-page").on("click", "a", function() {
        ...
        n("header").hasClass("active") && n(".menu-btn").trigger("click")) : (n(".lines").removeClass("finish"),
    ...
    n(window).on("scroll", function() {
        ...
        n(".mouse_btn").fadeOut()),
        n(this).scrollTop() <= 100 && 1 < n(".section").length && (n(".header").removeClass("fixed"),
        n(".footer").removeClass("fixed"),
        n(".mouse_btn").fadeIn())
    }),
    n("header").on("click", ".menu-btn", function() {
        return n("header").hasClass("active") ? (n("header").removeClass("active"),
        n(".footer .soc").fadeIn(),
        n("body").addClass("loaded"),
        n(".video-bg").length && n("body").addClass("background-enabled")) : (n("header").addClass("active"),
        n(".footer .soc").hide(),
    ...
    i ? n(".video-mobile-bg").each(function() {
    ...
    n("#cform").validate({
        ...
        submitHandler: function() {
            n.ajax({
                ...
                success: function(e) {
                    n("#cform").fadeOut(),
                    n(".alert-success").delay(1e3).fadeIn()
                }
            })
        }
    }),
